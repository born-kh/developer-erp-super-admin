...
export const packages: PackagePlan[] = [
  {
    ...
    name: "Шахматка",
    active: true,
    description: "Визуальная сетка объектов со статусами продаж в реальном времени.",
    modules: ["Планировки", "Статусы объектов", "Фильтры по этажам", "Бронирование"],
  },
  {
    id: "sales-dept",
    name: "Отдел продаж",
    active: true,
    description: "Управление менеджерами по продажам, сделками и воронкой клиентов.",
    modules: ["Воронка сделок", "Карточки клиентов", "KPI менеджеров", "Договоры"],
  },
  {
    id: "payment-calendar",
    name: "Календарь платежей",
    active: true,
    description: "График платежей по рассрочке и напоминания об оплате.",
    modules: ["График рассрочки", "Напоминания", "История оплат", "Просрочки"],
  },
  {
    id: "administrator",
    name: "Администратор",
    active: true,
    description: "Права доступа и настройка ролей сотрудников компании.",
    modules: ["Роли и права", "Аудит действий", "Настройки компании", "Управление сотрудниками"],
  },
  {
    id: "dashboard-reports",
    name: "Dashboard и отчёты",
    active: true,
    description: "Аналитика продаж, платежей и загрузки объектов в одном месте.",
    modules: ["Отчёты по продажам", "Финансовая аналитика", "Экспорт в Excel", "Графики динамики"],
  },
  {
    id: "warehouse",
    name: "Склад",
    active: false,
    description: "Учёт строительных материалов и остатков на объектах.",
    modules: ["Приход и расход", "Остатки на складе", "Инвентаризация", "Штрихкоды"],
  },
  {
    id: "procurement",
    name: "Закупки",
    active: false,
    description: "Заявки на закупку материалов и контроль поставщиков.",
    modules: ["Заявки на закупку", "Поставщики", "Согласование", "История цен"],
  },
  {
    id: "contractors",
    name: "Подрядчики",
    active: false,
    description: "Учёт подрядных организаций, актов выполненных работ и оплат.",
    modules: ["Реестр подрядчиков", "Акты выполненных работ", "Оплаты подрядчикам", "Договоры"],
  },
];
...
export const tariffs: TariffPlan[] = [
  {
    ...
    price: 99,
    active: true,
    description: "Базовый набор для продаж и учёта платежей одной компании.",
    packageIds: ["shahmatka", "sales-dept", "payment-calendar", "administrator", "dashboard-reports"],
  },
  {
    id: "pro",
    name: "Pro",
    price: 249,
    active: true,
    description: "Всё из Start плюс склад и закупки для растущей компании.",
    packageIds: [
      "shahmatka",
      "sales-dept",
      "payment-calendar",
  ...
  },
  {
    ...
    price: 399,
    active: false,
    description: "Полный набор модулей, включая подрядчиков, для крупных застройщиков.",
    packageIds: [
      "shahmatka",
      "sales-dept",
      "payment-calendar",
